    ...
    with torch.no_grad():
        ...
        for batch_num, batch in enumerate(tqdm(dataloaders["test"])):
            ...
            for i in tqdm(range(len(batch["text"]))):
                ...
                pred_text_bs, pred_text_bs_lm = text_encoder.ctc_beam_search_lm(probs, beam_size=100)
        ...
        results.append(
            {
                "avg test-clean cer argmax": res_metrics["cer_argmax"]/res_metrics["n_obj"],
                "avg test-clean wer argmax": res_metrics["wer_argmax"]/res_metrics["n_obj"],
                "avg test-clean cer beam search": res_metrics["cer_bs"]/res_metrics["n_obj"],
                "avg test-clean wer beam search": res_metrics["wer_bs"]/res_metrics["n_obj"],
                "avg test-clean cer beam search + lm": res_metrics["cer_bs_lm"]/res_metrics["n_obj"],
                "avg test-clean wer beam search + lm": res_metrics["wer_bs_lm"]/res_metrics["n_obj"],
            }
        )
